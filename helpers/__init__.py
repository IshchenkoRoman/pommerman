...
import os
from .. import agents
from pommerman.agents.TensorFlowAgent import TensorFlowAgent
...
def make_agent_from_string(agent_string, agent_id, docker_env_dict=None):
    ...
    print("AS = ", agent_string)
    agent_type, agent_control = agent_string.split("::")

    assert agent_type in ["player", "random", "docker", "test", "tensorforce", "tensorflow"]
    ...
    if agent_type == "player":
        ...
        agent_instance = TensorFlowAgent.TensorFlowAgent()
